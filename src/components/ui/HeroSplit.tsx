...
export function HeroSplit({
  ...
  return (
    <section className="relative w-full min-h-[80vh] flex flex-col md:flex-row bg-[#F7F5F0]">
      ...
      <div className="flex-1 flex items-center justify-center p-8 md:p-16 lg:p-24 order-2 md:order-1 relative z-10">
        <div className="max-w-xl">
          ...
          <FadeIn delay={0.3} direction="up">
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl mb-6 text-[#171716] leading-tight">
              {title}
            </h1>
          </FadeIn>
          ...
          {buttonText && buttonLink && (
            <FadeIn delay={0.7} direction="up">
                <Link 
                  href={buttonLink}
                  className="inline-block bg-black/5 backdrop-blur-md text-[#171716] px-10 py-4 uppercase tracking-widest text-sm transition-all duration-500 rounded-none border border-[#171716]/20 hover:border-[#171716] hover:bg-[#171716] hover:text-white"
                >
                {buttonText}
              </Link>
            </FadeIn>
