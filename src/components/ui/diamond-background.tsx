...
function DiamondBackground({
  ...
  return (
    <div
      ...
      className={cn(
        'relative size-full overflow-hidden bg-[#111111]',
        className,
      )}
      {...props}
    >
              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    "after:content-[''] after:absolute after:inset-[var(--diamond-margin)] after:bg-[#111111]",
                    'after:[clip-path:polygon(50%_0%,_100%_50%,_50%_100%,_0%_50%)]',
                    // Hover states for glow effect
                    'hover:drop-shadow-[0_0_15px_rgba(212,175,55,0.8)] z-0 hover:z-10',
                    'hover:before:bg-[#d4af37] hover:before:opacity-100 hover:before:duration-0',
