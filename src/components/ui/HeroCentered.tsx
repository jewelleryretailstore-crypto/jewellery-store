...
export function HeroCentered({
  ...
  return (
    <section className="relative h-[90vh] w-full flex items-center overflow-hidden bg-[#111111]">
            ...
            <div className="flex flex-col sm:flex-row gap-5 mt-4">
              {primaryButtonText && primaryButtonLink && (
                <Link 
                  ...
                  className="group relative bg-transparent text-white px-10 py-4 uppercase tracking-widest text-[11px] font-medium transition-all duration-500 rounded-[5px] border border-[#d4af37]/30 hover:border-[#d4af37] hover:shadow-[0_0_20px_rgba(212,175,55,0.3)]"
                >
